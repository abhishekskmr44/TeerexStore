...
const FilterListItems = (props) => {
    ...
    const setFilterState = (state) => {
        productDispatch({ type: "FILTER_BY_COLOR", payload: state.colour });
        productDispatch({ type: "FILTER_BY_TYPES", payload: state.type });
        productDispatch({ type: "FILTER_BY_GENDERS", payload: state.gender });
        productDispatch({ type: "FILTER_BY_COST", payload: state.price });
    };
